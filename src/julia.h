...
// JL_DLLEXPORT void        jl_set_nth_field_immutable(jl_value_t *v, size_t i, jl_value_t *rhs);
// JL_DLLEXPORT void        jl_set_nth_field_through_ptr_c(jl_value_t * const*v, size_t i, jl_value_t *rhs);
